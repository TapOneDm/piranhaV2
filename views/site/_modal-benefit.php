<div class="modal modal-benefit">
    <div class="modal-content">
        ...
        <div class="modal-body"><?= Yii::t('app', 'Записаться на первую тренировку со скидкой 50%') ?></div>
        <div class="modal-actions">
            <button data-modal-open data-benefit="true" data-modal="modal-sign" class="primary" type="button"><?= Yii::t('app', 'Записаться') ?></button>
            <button data-modal-close data-benefit="true" type="button"><?= Yii::t('app', 'Закрыть') ?></button>
        </div>
    </div> 
</div>