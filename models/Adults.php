    ...
    public static function getItems() {
        return [
            [
                ...
                'text' => Yii::t('app', 'Для многих русскоговорящих экспатов плавание становится не только возможностью поддержать физическую форму, но и найти новых друзей и единомышленников. Наши тренировки создают идеальные условия для общения и восстановления социальных связей.'),
            ],
            [
